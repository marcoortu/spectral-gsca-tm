...
\title{Structural Topic Modeling in Aitchison Geometry:\\
  An Analytical Spectral Solution via ILR-EGSCA}
\date{\today}
\maketitle
...
linearised ILR-EGSCA objective, clarify the identifiability conditions
...
\end{equation}
%
subject to the EGSCA normalisation constraint
\begin{equation}
...
% ---- Main theorem ------------------------------------------------
\subsection{The ILR-EGSCA Spectral Theorem}
...
This section establishes the theoretical foundations of the ILR-EGSCA
...
The ILR-EGSCA topic model sits at the intersection of three established
frameworks:
%
\begin{enumerate}
...
\begin{algorithm}[t]
\caption{ILR-EGSCA Structural Topic Model}
\label{alg:ilr_egsca}
\begin{algorithmic}[1]
